...
1. Übersetzungen von sieben Erzählungen aus Dietericis Chrestomathie Ottomane, Berlin 1854, S. 31-38.
2. Übersetzung von achtzehn türkischsprachigen Fabeln aus Letelliers Choix des Fables Turques, Paris 1826.
3. Zwei Märchen und eine Fabel.
4. Eine ausführliche Erzählung über das Schicksal des Mir von Palu, Awdullah-Baeg.
5. Eine Erzählung über die unglückliche Liebe der Tochter eines Stammesoberhaupts vom Stamm Römi.
6. Eine Übersetzung der finnischen Rune, die Zetterquist vorläufig in sechs Sprachen veröffentlicht hatte.

### b) Im Zazä-Dialekt

1. Drei ausführlichere Erzählungen über Fehden zwischen kurdischen Stämmen.
2. Zwei Märchen.
3. Eine Sage vom Vogel gö’in, dem Uhu.
...
In den Nachträgen gibt es einige kleine, aber für Zazä nützliche Hinweise. Einer davon notiert schlicht, dass Zazä die Postposition `ver` besitzt. Ein anderer betrifft den Vogelnamen `go'in`: Lerch verbindet die Zazä-Formen `gö'en` und `gö'in` mit neupersischem `xun` und erklärt sie über einen Übergang von `v` zu einem gutturalen Laut; als vermittelnde Formen nennt er Kurmändi `xo'in` und `xu'in`. Diese etymologischen Notizen sind eher technisches Material, aber sie zeigen, wie eng Lerch Glossar, Texte und vergleichende iranische Sprachwissenschaft miteinander verband.
