...
- `dorn-report`: B. von Dorn's Roslavl Report / B. von Dorn'un Roslavl Raporu / B. von Dorns Bericht über Roslawl
- `method-hassan`: Lerch's Method and Hassan / Lerch'in Yöntemi ve Hassan / Lerchs Methode und Hassan
- `hassan-context`: Hassan Dialogue Context / Hassan Diyaloğu Bağlamı / Das Gespräch mit Hassan als Quellenkontext
