...
const publication = {
  ...
  'gespraech-mit-hassan': {
    ...
    places_tr: 'Sivan/Servi; Kasan/Kassau/Kaschan (Günkondu veya Doğanlı çevresindeki Kaşan/Qaşan olasılığı); Gewel/Gevil; Aldun/Alaaddin; Talek; Weşin; Karbegan/Karabegan; Hyêni/Hêni/Hani; Nyêrib/Nerib/Kuyular; Kavare; Gowman.',
    place_links: [
      place('Sivan', 'Servi', 'Servi, Genç, Bingöl'),
      place('Kasan/Kasun (yaygın eşleştirme)', 'Günkondu', 'Günkondu, Genç, Bingöl'),
      place('Kaşan/Qaşan (Kiepert Kaschan için olası eşleştirme)', 'Doğanlı/Kelahsı çevresi', 'Doğanlı, Genç, Bingöl'),
    ...
    editorial_note_tr: "Hassan/Hasan yazımı Lerch'in biçimine göre korunur. Kasan/Kassau/Kaschan için Günkondu ve Doğanlı çevresindeki Kaşan/Qaşan olasılıkları birlikte gösterilir. Horsik/Saklıca, Aldun/Alaaddin ve Hêmek/Hamek/Yeniler gibi Sivan köyleri kaynakla desteklenir; Weşin, Talek, Kavare ve Gowman gibi adlar anlatının yerel coğrafyasını belgeleyen diğer adlardır. Kiepert haritasındaki Melken adı, Melêkang/Melekan = Sarıbudak eşleştirmesini güçlendirir.",
  },
